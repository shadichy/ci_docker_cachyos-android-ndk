...
RUN paru -S --noconfirm --skipreview --batchinstall --needed android-ndk android-ndk-beta android-sdk go-android-bin nasm yasm meson ninja mesa glu libdrm libva dav1d libx86 libpulse alsa-lib libxv libxcb libvdpau libglvnd cmake pigz
